...
############################################
# NAT Gateway — required: ECS tasks in private subnets call
# login.microsoftonline.com and graph.microsoft.com. A fully
# air-gapped VPC is not compatible with this app as built.
############################################
...
resource "aws_security_group" "ecs" {
  ...
  description = "Allow inbound from the ALB only; outbound needed for Microsoft Entra ID / Graph calls via NAT."
  vpc_id      = aws_vpc.this.id
