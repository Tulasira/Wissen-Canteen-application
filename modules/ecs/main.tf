...
resource "aws_ecs_service" "api" {
  ...
  lifecycle {
    # Deploys update the task definition's image tag out-of-band (CI/CD);
    # don't let a stale bootstrap tag in state fight with that.
...
############################################
# Phase 2 — optional CPU-based autoscaling
############################################
